    ...
    return (
        <View style={[styles.container, style]}>
                ...
                <View style={styles.containerUserInfo}>
                    ...
                    <View style={styles.contentInfo}>
                        <Text
                            ...
                            {userName}{' '}
                            <Text style={styles.dateText}>{transformToDate(updatedAt)}</Text>
                        </Text>
                        <Rating
                            startingValue={Number(rate)}
                            type="star"
                            imageSize={15}
                            style={styles.stars}
                            readonly
                    ...
                    {photoReview[2] && (
                        <View style={styles.loadMoreImage}>
                            <Image
                                style={styles.img}
                                resizeMode="contain"
                                source={{uri: photoReview[2]}}
                            />
                            <View style={styles.loadMoreNumber}>
                                <Text style={styles.loadMoreNumberText}>
                                    +{photoReview.length - 2}
                                </Text>
                            </View>
                        </View>
                    )}
            ...
            <View style={styles.controlAction}>
                <LoadingButton text="Like" style={styles.button}>
                    <AntDesign name="like1" color="grey" size={20} />
                </LoadingButton>
                <LoadingButton text="Share" style={styles.button}>
