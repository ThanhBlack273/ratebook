        ...
        <View style={styles.container}>
            <FlatList
                ...
                ListHeaderComponent={
                    book ? (
                        <DetailBook
                            ...
                            likedListUser={book.likedListUser}
                ...
                renderItem={({item}) => (
                    <Comment
                        ...
                        likedReviewListUser={item.likedReviewListUser}
            ...
            <View style={styles.control}>
                <LoadingButton
                    ...
                    onPress={() => dispatch(updateModalType({type: 'REQUEST_TO_REVIEW', value: route.params.id}))}
                />
                <LoadingButton
                    text="New comment"
                    style={styles.button}
                    onPress={() => dispatch(updateModalType({type: 'NEW_COMMENT', value: route.params.id}))}
                />
            </View>
        </View>
    );
